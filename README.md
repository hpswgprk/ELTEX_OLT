...
__OLT__ (Optical Linear Terminal) – Оптический Линейный Терминал. L2 или L3 свитч со всеми вытекающими отсюда функциональными возможностями, имеющий Uplink порты (обычно стандарта Ethernet) и Downlink порты (работающие в рамках стандартов ITU-T G.984 / GPON).

__ONT__ (Optical Network Terminal) – Оптический Сетевой Терминал. Оборудование устанавливаемое на стороне абонента.
...
Просмотр списка маков на порту (в контексте switch):
    ...
    show mac include interface pon-port 0
