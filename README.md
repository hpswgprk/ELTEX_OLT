...
Просмотр текущей конфигурации параметров управления производится командой "show management".
...
Просмотр списка пользователей производится командой show users:
...
Добавление новых пользователей производится командой user в режиме конфигурирования:
...
Назнаение пароля для пользователя:
...
Просмотреть текущую конфигурацию можно используя команду show gpon olt configuration:
...
Не забудьте применить и сохранить внесённые изменения командами commit и save.

## 6. Добавление ONT
При подключении нового абонентского устройства оно будет отображаться в неактивированном состоянии.
Такие устройства можно просмотреть командой show interface 0-7 unactivated:
...
Просмотреть список имеющихся шаблонов можно с помощью команды show template:
...
В этом меню нужно сконфигурировать профиль с помощью команды set property.
...
Посмотреть список доступных профилей можно с помощью команды show list:
